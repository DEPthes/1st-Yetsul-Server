...
export class UserRepository extends Repository<User> {
    ...
    async editUser(id, nickname, url) {
        // const profileImg = url.location;
        let profileImg;
            if (url == null)
            profileImg = 'https://depthes.s3.ap-northeast-2.amazonaws.com/1659277489924-%EB%94%94%ED%8F%B4%ED%8A%B8%EC%9D%B4%EB%AF%B8%EC%A7%80.png';
            else {
